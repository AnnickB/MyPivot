(function() {
  ...
  callWithJQuery(function($) {
     ...
     */
    PivotData = (function() {
      function PivotData(input, opts, modalities) {
        ...
        this.sorted = false;
        this.Interval1 = interval1.value; //add by ABI on 4/11
        this.Interval2 = interval2.value;
        this.Interval3 = interval3.value;
        this.Interval4 = interval4.value;
        this.Colour1 = colour1.style.backgroundColor; //add by ABI on 23/11
        this.Colour2 = colour2.style.backgroundColor;
        this.Colour3 = colour3.style.backgroundColor;
        this.Colour4 = colour4.style.backgroundColor;
        this.Colour5 = colour5.style.backgroundColor;
    ...
    pivotTableRenderer = function(pivotData, opts) {
      var aggregator, c, colAttrs, colKey, colKeys, defaults, i, j, r, result, rowAttrs, rowKey, rowKeys, spanSize, tbody, td, th, thead, totalAggregator, tr, txt, val, x, interval1, interval2, interval3, interval4; colour1, colour2, colour3, colour4, colour5;
                                                                                                            //add by ABI on 4/11 & 23/11
      defaults = {
        localeStrings: {
          totals: "Totals"
        }
      ...
      interval1 = pivotData.Interval1;
      interval2 = pivotData.Interval2;
      interval3 = pivotData.Interval3;
      interval4 = pivotData.Interval4;
      colour1 = pivotData.Colour1;
      colour2 = pivotData.Colour2;
      colour3 = pivotData.Colour3;
      colour4 = pivotData.Colour4;
      colour5 = pivotData.Colour5;
...
colour1, colour2, colour3, colour4, colour5 ;
    ...
    $.fn.heatmap = function(scope, opts) {
      var colorScaleGenerator, heatmapper, i, j, l, n, numCols, numRows, ref, ref1, ref2, int1, int2, int3, int4;
      if (scope == null) {
        scope = "heatmap";
      }
      numRows = this.data("numrows");
      numCols = this.data("numcols");
      int1 = interval1.value;
      int2 = interval2.value;
      int3 = interval3.value;
      int4 = interval4.value;
      col1 = colour1.style.backgroundColor;
      col2 = colour2.style.backgroundColor;
      col3 = colour3.style.backgroundColor;
      col4 = colour4.style.backgroundColor;
      col5 = colour5.style.backgroundColor;

      colorScaleGenerator = opts != null ? (ref = opts.heatmap) != null ? ref.colorScaleGenerator : void 0 : void 0;
      if (colorScaleGenerator == null) {
        colorScaleGenerator = function(values) {
            //website for css color codes: http://colours.neilorangepeel.com
            return function(x) {
              if(x<int1) { //Add by ABI on 4/11
                return col1; //"rgb(50,205,50)"; //limegreen
              } else if (x<int2) {
                  return col2; //"rgb(154,205,50)"; //yellowgreen
              } else if (x<int3) {
                  return col3; //"rgb(255,215,0)"; //gold
              } else if (x<int4) {
                  return col4; //"rgb(255,165,0)"; //orange
              } else {
                  return col5; //"rgb(255,69,0)"; //orangered
              }
            };
          };
      }
