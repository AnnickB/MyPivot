  ...
  callWithJQuery(function($) {
    ...
    PivotData = (function() {
      function PivotData(input, opts, modalities) {
        ...
        //this.Order_Modalities = console.r.get("Order_Modalities");
    ...
    pivotTableRenderer = function(pivotData, opts) {
      var aggregator, c, colAttrs, colKey, colKeys, defaults, i, j, r, result, rowAttrs, rowKey, rowKeys, spanSize, tbody, td, th, thead, totalAggregator, tr, txt, val, x, interval1, interval2, interval3, interval4; //add by ABI on 4/11
      defaults = {
        localeStrings: {
          totals: "Totals"
        }
        ...
        colorScaleGenerator = function(values) {
            ...
            return function(x) {
              if(x<int1) { //Add by ABI on 4/11
                return "rgb(50,205,50)"; //limegreen
              } else if (x<int2) {
                  return "rgb(154,205,50)"; //yellowgreen
              } else if (x<int3) {
