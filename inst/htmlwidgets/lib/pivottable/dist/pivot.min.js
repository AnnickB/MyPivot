  ...
  callWithJQuery(function($) {
    ...
    PivotData = (function() {
      function PivotData(input, opts) {
        ...
        this.sorted = false;
        this.interval = opts.interval_heatmap; //add by ABI on 4/11
    ...
    pivotTableRenderer = function(pivotData, opts) {
      var aggregator, c, colAttrs, colKey, colKeys, defaults, i, j, r, result, rowAttrs, rowKey, rowKeys, spanSize, tbody, td, th, thead, totalAggregator, tr, txt, val, x, interval; //add by ABI on 4/11
      defaults = {
        localeStrings: {
          totals: "Totals"
        }
      ...
      interval = pivotData.getInterval();
      ...
      result.setAttribute("data-interval",interval.length);
      return result;
    };
    ...
    $.fn.heatmap = function(scope, opts) {
      var colorScaleGenerator, heatmapper, i, j, l, n, numCols, numRows, ref, ref1, ref2, int;
      if (scope == null) {
        scope = "heatmap";
      }
      numRows = this.data("numrows");
      numCols = this.data("numcols");
      int = this.data("interval");
      colorScaleGenerator = opts != null ? (ref = opts.heatmap) != null ? ref.colorScaleGenerator : void 0 : void 0;
      if (colorScaleGenerator == null) {
        colorScaleGenerator = function(values) {
            return function(x) {
              if(x in int) { //Add by ABI on 4/11
                return "rgb(0,255,0)";
              } else {
                  return "rgb(255,0,0)";
              }
