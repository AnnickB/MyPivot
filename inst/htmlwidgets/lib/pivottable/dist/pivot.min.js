  ...
  callWithJQuery(function($) {
    ...
    PivotData = (function() {
      function PivotData(input, opts, modalities) {
        ...
        this.Colour1 = colour1; //add by ABI on 23/11
...
colour1, colour2, colour3, colour4, colour5 ;
    ...
    $.fn.heatmap = function(scope, opts) {
      var colorScaleGenerator, heatmapper, i, j, l, n, numCols, numRows, ref, ref1, ref2, int1, int2, int3, int4, col1, col2, col3, col4, col5;
      if (scope == null) {
        scope = "heatmap";
      }
